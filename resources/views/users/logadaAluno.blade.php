...
@include('layout._menu') 
    ...
    <div class="engloba-logada">
        <h1>Bem vindo(a), $$$$chamar variavel nome$$$</h1>
        <div class="card-logada iniciante-estudante">
            <div class="img-log">   
                <img src="img/estudante-log.png" alt="ícone do estudante">
            </div>
            <div class="texto-log">
            ...
            <div class="btn-continuar">
                <button class="btn-estudante">Continuar</button>
            </div>
        </div>
