...
function trocarDesativa(desativa){
    if(desativa.classList.contains('bi-toggle-off')){
        desativa.classList.remove('bi-toggle-off');
        desativa.classList.add('bi-toggle-on');
    }//fim do if
    else{
